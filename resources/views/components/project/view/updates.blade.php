                    ...
                    <div class="accordion-item">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <div class="ms-auto dropdown">
                                <a class="btn circle ms-auto align-self-center " data-bs-toggle="dropdown" aria-expanded="false" disabled><i class="fa-solid fa-ellipsis"></i></a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item editUpdate" type="button" data-bs-toggle="modal" data-bs-target="#updateEditModal" data-id={{$updates[$i]['id']}}>Edit</a></li>
                        ...
                        aria-labelledby="update-acord-content-{{$updates[$i]['id']}}" data-bs-parent="#info-update-accordion">
