    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content border-info">
        ...
        <div class="modal-body p-4">
            <form method="post" action="{{ route('progress.create') }}" accept-charset="UTF-8" id = "updateForm">
                @csrf
            ...
            <button type="submit" id="updateSubmit" class="btn btn-primary mx-4 mb-4">Post</button>
        </form>
      </div>
    </div>
    </div>